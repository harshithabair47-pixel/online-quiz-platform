    ...
    <div style={{ display: 'flex', background: '#181825', minHeight: '100vh' }}>
      ...
      <div style={{ flex: 1, padding: '40px', color: '#cdd6f4' }}>
        <div style={{
          ...
          <button onClick={() => navigate('/quizzes/create')} style={{
            ...
            <div style={{ display: 'flex', gap: '12px' }}>
              ...
              <button onClick={() => {
                navigator.clipboard.writeText(
                  `http://localhost:5173/quiz/${quiz._id}`
                );
                alert('Quiz link copied! Share with students!');
              }} style={{
                padding: '8px 16px', background: '#a6e3a1', border: 'none',
                borderRadius: '6px', cursor: 'pointer',
                color: '#1e1e2e', fontWeight: 'bold'
              }}>Share 🔗</button>
            </div>
